...
describe('CodexNotificationRouter', () => {
  ...
  describe('dynamicToolCall', () => {
    ...
    it('deduplicates raw-first dynamic events and resets the result guard between turns', () => {
      const completedItem = {
        type: 'dynamicToolCall',
        id: 'call_dynamic_reused',
        namespace: 'codex_app',
        tool: 'load_workspace_dependencies',
        arguments: {},
        status: 'completed',
      ...
      router.handleNotification('item/started', {
        item: { ...completedItem, status: 'inProgress', contentItems: null, success: null },
        threadId: 't1',
        turnId: 'turn1',
      });
      router.handleNotification('item/completed', {
